...
/*   Updated: 2022/02/08 15:11:45 by rtracee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : name("..."), Hit(10), Energy(10), Damage(0){
	COUT << "Default ClapTrap constructor with ... called" << ENDL;
}

ClapTrap::ClapTrap(STRING name) : name(name), Hit(10), Energy(10), Damage(0){
	COUT << "Default ClapTrap constructor with " << this->name << " called." << ENDL;
}
...
ClapTrap::~ClapTrap()
{
	COUT << "Default ClapTrap destructor with " << this->name << " called." << ENDL;
}
